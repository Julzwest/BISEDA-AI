  ...
  return (
    <div className="relative" ref={triggerRef}>
      ...
      <button
        ...
        className="group flex items-center justify-center gap-0.5 w-11 h-11 bg-slate-800/90 border border-slate-700/60 rounded-xl hover:bg-slate-700/90 hover:border-purple-500/50 transition-all duration-200"
      ...
      >
        ...
        <ChevronDown 
          className={`w-3 h-3 text-slate-400 group-hover:text-purple-400 transition-all duration-200 ${
            isOpen ? 'rotate-180' : ''
          }`} 
        />
      </button>
